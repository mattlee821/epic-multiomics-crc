...
# data ====
data <- read.table("analysis/002_analysis/metabolomics/negative/results_formatted.txt", header = T, sep = "\t")
...
pdf("analysis/002_analysis/metabolomics/negative/figures/001_model_comparison_sex-combined.pdf",
...
pdf("analysis/002_analysis/metabolomics/negative/figures/001_model_comparison_female.pdf",
    width = 16, height = 130, pointsize = 10)
my_forestplot(df = plot_data,
              name = exposure,
              estimate = b,
...
pdf("analysis/002_analysis/metabolomics/negative/figures/001_model_comparison_male.pdf",
    width = 16, height = 130, pointsize = 10)
my_forestplot(df = plot_data,
              name = exposure,
              estimate = b,
...
pdf("analysis/002_analysis/metabolomics/negative/figures/002_sex_site-specific_m5.pdf",
...
pdf("analysis/002_analysis/metabolomics/negative/figures/002_sex_site-specific_highlight_m5.pdf",
    width = 16, height = 22, pointsize = 10)
my_forestplot(df = plot_data,
              name = exposure,
              estimate = b,
...
pdf("analysis/002_analysis/metabolomics/negative/figures/002_sex_site-specific_highlight-only_m5.pdf",
...
pdf("analysis/002_analysis/metabolomics/negative/figures/002_sex_site-specific_highlight-only_m5_2.pdf",
...
data1 <- data1 %>%
  mutate(direction_group = case_when(direction == 1 ~ "negative",
                                     direction == 2 ~ "negative",
                                     direction == 0 ~ "inconsistent"))
data1$direction_group <- factor(data1$direction_group,
                                levels = c("negative", "negative", "inconsistent"),ordered = TRUE)
data1 <- data1[,c(4,5)]
...
pdf("analysis/002_analysis/metabolomics/negative/figures/003_site-specific_sex_m5_directional-consistency.pdf",
...
pdf("analysis/002_analysis/metabolomics/negative/figures/003_sex_site-specific_m5_directional-consistency.pdf",
    width = 8, height = 6, pointsize = 10)
ggplot(data = data_direction,
       aes(x = exposure)) +
  geom_bar(aes(fill = direction_group))  +
...
pdf("analysis/002_analysis/metabolomics/negative/figures/004_combined_site-specific_followup_m5_highlight.pdf",
    width = 16, height = 22, pointsize = 10)
...
pdf("analysis/002_analysis/metabolomics/negative/figures/004_female_site-specific_followup_m5_highlight.pdf",
    width = 16, height = 22, pointsize = 10)
...
pdf("analysis/002_analysis/metabolomics/negative/figures/004_male_site-specific_followup_m5_highlight.pdf",
    width = 16, height = 22, pointsize = 10)
...
pdf("analysis/002_analysis/metabolomics/negative/figures/004_sex_site-specific_followup_highlight_m5.pdf",
...
pdf("analysis/002_analysis/metabolomics/negative/figures/004_sex_site-specific_followup_highlight_m5_2.pdf",
...
pdf("analysis/002_analysis/metabolomics/negative/figures/005_sex_site-specific_followup_highlight_interesting_m5.pdf",
