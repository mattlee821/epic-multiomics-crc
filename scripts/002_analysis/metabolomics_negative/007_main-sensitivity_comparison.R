...
# data ====
data_main <- read.table("analysis/002_analysis/metabolomics/negative/results_formatted.txt", header = T, sep = "\t")
data_sensitivity <- read.table("analysis/002_analysis/metabolomics/negative/results_2y-followup_formatted.txt", header = T, sep = "\t")
...
pdf("analysis/002_analysis/metabolomics/negative/figures/006_main-sensitivity_comparison_m5.pdf",
...
pdf("analysis/002_analysis/metabolomics/negative/figures/006_main-sensitivity_comparison_main-highlighted_m5.pdf",
    width = 8, height = 100, pointsize = 10)
...
pdf("analysis/002_analysis/metabolomics/negative/figures/006_main-sensitivity_comparison_followup-highlighted_m5.pdf",
    width = 10, height = 200, pointsize = 10)
my_forestplot(df = plot_data,
              name = exposure,
              estimate = b,
              pvalue = p,
...
# 
# plot_data <- subset(data, model == "model 5")
# traits <- c("Olk_Il7", "Olk_Pdcd1", "Olk_Tnfrsf4", "Olk_Tnfrsf9")
# plot_data <- plot_data[plot_data$exposure %in% traits, ]
# plot_data$followup <- factor(plot_data$followup, levels = c("below", "all", "above"))
# plot_data <- plot_data %>%
#   mutate(ci_solid = ifelse(lower_ci > 1 | upper_ci < 1, 0, 1))
# 
# pdf("analysis/002_analysis/metabolomics/negative/figures/006_main-sensitivity_comparison_followup-highlighted_interesting_m5.pdf",
