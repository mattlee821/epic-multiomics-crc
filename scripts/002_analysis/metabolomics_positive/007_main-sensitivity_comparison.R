...
# data ====
data_main <- read.table("analysis/002_analysis/metabolomics/positive/results_formatted.txt", header = T, sep = "\t")
data_sensitivity <- read.table("analysis/002_analysis/metabolomics/positive/results_2y-followup_formatted.txt", header = T, sep = "\t")
...
pdf("analysis/002_analysis/metabolomics/positive/figures/006_main-sensitivity_comparison_m5.pdf",
...
pdf("analysis/002_analysis/metabolomics/positive/figures/006_main-sensitivity_comparison_main-highlighted_m5.pdf",
...
pdf("analysis/002_analysis/metabolomics/positive/figures/006_main-sensitivity_comparison_followup-highlighted_m5.pdf",
...
# 
# pdf("analysis/002_analysis/metabolomics/positive/figures/006_main-sensitivity_comparison_followup-highlighted_interesting_m5.pdf",
